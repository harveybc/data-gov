...
class DataGovClient:
    ...
    def _save(self, response, dest: Path, *, governing=False, default_ext=""):
        ...
        info = {
            ...
            "availability_use": response.header("X-Availability-Use") or "UNDECLARED",
            "availability_label": response.header("X-Availability-Label") or "UNKNOWN",
            "availability_completion_lag_max": response.header("X-Availability-Completion-Lag-Max") or None,
